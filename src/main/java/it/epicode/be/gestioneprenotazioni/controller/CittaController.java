...
import it.epicode.be.gestioneprenotazioni.service.CittaService;
...
public class CittaController {
	...
	public ResponseEntity<String> delete(@PathVariable Long id) {
		...
		return new ResponseEntity<>("Città deleted", HttpStatus.OK);
...
//	public String findB() {
//		
//		return "SONO UN METODO DI PROVA, SERVO A VERIFICARE L'AUTENTICAZIONE";
//
//	}
