package it.epicode.be.gestioneprenotazioni.config;
...
import it.epicode.be.gestioneprenotazioni.common.util.AuthEntryPointUnauthorizedJwt;
import it.epicode.be.gestioneprenotazioni.common.util.AuthTokenFilter;
import it.epicode.be.gestioneprenotazioni.model.Roles;
import it.epicode.be.gestioneprenotazioni.service.UserDetailsServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        //.antMatchers("/a/ciao/**").hasAnyRole("ROLE_ADMIN")
        .and()
        .exceptionHandling()
